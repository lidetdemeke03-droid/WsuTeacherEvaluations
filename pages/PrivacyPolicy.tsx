...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-4">Privacy Policy for Wolaita Sodo University Teacher Evaluation System</h1>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-bold mb-2">5. Your Choices</h2>
      <p className="mb-4">
