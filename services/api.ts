...
export const apiAssignEvaluation = (assignData: { studentIds: string[], courseId: string, teacherId: string }): Promise<any> => apiRequest<any>('/evaluations/assign', { method: 'POST', body: JSON.stringify(assignData) });
